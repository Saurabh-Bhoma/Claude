...
Loan Management System (LMS) backend. Manages the full lifecycle of home loans: origination, underwriting, disbursement, repayment schedules, collections, accounting, and compliance reporting.
...
- Call `create_merge_request` with:
  ...
  - **Assignee**: Saurabh Bhoma
  - **Reviewers**: Janis Jain
